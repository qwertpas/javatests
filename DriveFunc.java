...
public class DriveFunc {
    ...
    private static boolean isQuickTurning = true;
    private static boolean isInHighGear = false;

    public static void main(String[] args) {
        while (true) {
            double x = (MouseInfo.getPointerInfo().getLocation().getX() / 719.5) - 1;
            double y = -((MouseInfo.getPointerInfo().getLocation().getY() / 449.5) - 1);
            System.out.println(x + "  " + y + "  " + Arrays.toString(cheesyDrive(y, x, isQuickTurning, isInHighGear)));
